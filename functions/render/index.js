...
var require_parse5 = __commonJS({
  "node_modules/cheerio/lib/parsers/parse5.js"(exports) {
    ...
    var domhandler_1 = require_lib2();
    var parse5_1 = require_lib7();
    var parse5_htmlparser2_tree_adapter_1 = tslib_1.__importDefault(require_lib8());
  ...
  "node_modules/cheerio/lib/parse.js"(exports) {
    ...
    function parse(content, options2, isDocument) {
      ...
      if (typeof content === "string") {
        return options2.xmlMode || options2._useHtmlParser2 ? htmlparser2_2.parse(content, options2) : parse5_1.parse(content, options2, isDocument);
      }
      var doc = content;
  ...
  "node_modules/cheerio/lib/static.js"(exports) {
    ...
    function render2(that, dom, options2) {
      ...
      if (!dom) {
        ...
        dom = cheerio_select_1.select(dom, (_b = that === null || that === void 0 ? void 0 : that._root) !== null && _b !== void 0 ? _b : [], options2);
      }
      return options2.xmlMode || options2._useHtmlParser2 ? htmlparser2_2.render(dom, options2) : parse5_1.render(dom);
    }
    ...
    function html(dom, options2) {
      ...
      options2 = tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, options_1.default), this ? this._options : {}), options_1.flatten(options2 !== null && options2 !== void 0 ? options2 : {}));
      return render2(this || void 0, dom, options2);
    }
    exports.html = html;
    function xml(dom) {
...
var require_traversing = __commonJS({
  "node_modules/cheerio/lib/api/traversing.js"(exports) {
    ...
    function find(selectorOrHaystack) {
      ...
      var options2 = { context, xmlMode: this.options.xmlMode };
    ...
    var Cheerio = function() {
      function Cheerio2(selector, context, root, options2) {
        ...
        if (!(this instanceof Cheerio2)) {
          return new Cheerio2(selector, context, root, options2);
        }
        this.length = 0;
        this.options = tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, options_1.default), this.options), options_1.flatten(options2));
        if (!selector)
          return this;
        if (root) {
...
var require_load = __commonJS({
  "node_modules/cheerio/lib/load.js"(exports) {
    ...
    function load2(content, options2, isDocument) {
      ...
      options2 = tslib_1.__assign(tslib_1.__assign({}, options_1.default), options_1.flatten(options2));
      if (typeof isDocument === "undefined")
        isDocument = true;
      var root = parse_1.default(content, options2, isDocument);
      var initialize = function(_super) {
        ...
        function initialize2(selector, context, r, opts) {
          ...
          _this = _super.call(this, selector, context, r, tslib_1.__assign(tslib_1.__assign({}, options2), opts)) || this;
          return _this;
        }
...
var template = ({ head, body }) => '<!DOCTYPE html>\n<html lang="en">\n	<head>\n		<meta charset="utf-8" />\n		<link rel="icon" href="/favicon.png" />\n		<meta name="viewport" content="width=device-width, initial-scale=1" />\n		<!-- <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/water.css@2/out/water.css"> -->\n		<!-- <link rel="stylesheet" href="https://cdn.rawgit.com/kimeiga/bahunya/css/bahunya-0.1.3.css"/> -->\n		<!-- <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@exampledev/new.css@1.1.2/new.min.css"> -->\n		<!-- <link rel="stylesheet" href="https://unpkg.com/awsm.css/dist/awsm.min.css"> -->\n		<!-- <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/holiday.css@0.9.6" /> -->\n		<!-- <link rel="stylesheet" href="https://unpkg.com/sakura.css/css/sakura.css" type="text/css"> -->\n		<!-- <link rel="stylesheet" href="https://unpkg.com/mvp.css"> -->\n		<!-- <link rel="stylesheet" href="path_to_attricss_file.css" type="text/css"> -->\n		<link rel="stylesheet" href="https://unpkg.com/marx-css/css/marx.min.css">\n\n		<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/10.7.2/styles/default.min.css" integrity="sha512-kZqGbhf9JTB4bVJ0G8HCkqmaPcRgo88F0dneK30yku5Y/dep7CZfCnNml2Je/sY4lBoqoksXz4PtVXS4GHSUzQ==" crossorigin="anonymous" referrerpolicy="no-referrer" />\n		<script src="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/10.7.2/languages/json.min.js" integrity="sha512-37sW1XqaJmseHAGNg4N4Y01u6g2do6LZL8tsziiL5CMXGy04Th65OXROw2jeDeXLo5+4Fsx7pmhEJJw77htBFg==" crossorigin="anonymous" referrerpolicy="no-referrer"><\/script>		\n		' + head + '\n	</head>\n	<body>\n		<div id="svelte">' + body + "</div>\n	</body>\n</html>\n";
var options = null;
function init(settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-ceb98c8f.js",
      css: ["/./_app/assets/start-a8cd1609.css"],
      js: ["/./_app/start-ceb98c8f.js", "/./_app/chunks/vendor-b1eec9c2.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { ".svelte-kit/build/components/layout.svelte": { "entry": "/./_app/layout.svelte-1545e864.js", "css": [], "js": ["/./_app/layout.svelte-1545e864.js", "/./_app/chunks/vendor-b1eec9c2.js"], "styles": null }, ".svelte-kit/build/components/error.svelte": { "entry": "/./_app/error.svelte-eaed03cd.js", "css": [], "js": ["/./_app/error.svelte-eaed03cd.js", "/./_app/chunks/vendor-b1eec9c2.js"], "styles": null }, "src/routes/index.svelte": { "entry": "/./_app/pages/index.svelte-5857ce47.js", "css": [], "js": ["/./_app/pages/index.svelte-5857ce47.js", "/./_app/chunks/vendor-b1eec9c2.js"], "styles": null } };
...
async function get({ query }) {
  ...
  const data = (_a = $(selector)) == null ? void 0 : _a.map((i, node) => $(node).text().trim()).get();
  return {
    body: data
  };
}
...
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<main><header><h1>querySelectorAll</h1>
		<p>Extract data from any web site easy and fast. ex: 
			${each(examples, (ex, index2) => `<a href>${escape2(ex.title)}</a>\xA0`)}</p></header>
	
	<form action="${""}"><div><label for="${"url"}">URL</label>
			<input type="${"text"}" name="${"url"}"${add_attribute("value", url, 1)}></div>
		<br>
		<div><label for="${"selector"}">CSS Selector</label>
			<input type="${"text"}" name="${"selector"}"${add_attribute("value", selector, 1)}></div>
		<br>
		<button>JSON</button></form>
	${``}</main>`;
});
